...
一个强大、快速、功能丰富的Swift汉字拼音转换库，专为现代iOS开发设计。hanyupinyin提供了很多高级功能，包括完整的多音字支持、音调颜色显示、智能读音选择等。
...
```
https://github.com/zouliuyuhan/hanyupinyin.git
```
...
```swift
dependencies: [
    .package(url: "https://github.com/zouliuyuhan/hanyupinyin.git", from: "1.0.0")
]
```
...
- [使用指南](USAGE.md) - 详细的使用说明[未完成]
- [功能特性](FEATURES.md) - 完整的功能列表[未完成]
- [颜色配置指南](COLOR_CONFIG_GUIDE.md) - 颜色配置详细说明[未完成]
...
本库非常多代码资源来自https://github.com/teambition/HanziPinyin
---
